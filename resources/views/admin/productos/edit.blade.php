...
<div class="container py-8">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl shadow-xl p-6 mb-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-white">Editar Producto</h1>
                <p class="text-white text-opacity-90 mt-1">Modifica la información del producto</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-12 py-3 sm:text-sm border-gray-300 rounded-md" value="{{ old('nombre', $producto->nombre) }}" required>
                    </div>
                </div>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="number" id="precio" name="precio" step="0.01" min="0" class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-12 py-3 sm:text-sm border-gray-300 rounded-md" value="{{ old('precio', $producto->precio) }}" required>
