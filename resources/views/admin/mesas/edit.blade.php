...
<div class="container py-8">
    ...
    <div class="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl shadow-xl p-6 mb-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-white">Editar Mesa</h1>
                <p class="text-white text-opacity-90 mt-1">Modifica la información de la mesa</p>
            </div>
        ...
        <form action="{{ route('admin.mesas.update', $mesa->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="relative rounded-md shadow-sm">
                    ...
                    <input type="text" id="nombre" name="nombre" class="focus:ring-purple-500 focus:border-purple-500 block w-full pl-10 pr-12 py-3 sm:text-sm border-gray-300 rounded-md" value="{{ old('nombre', $mesa->nombre) }}" required>
                </div>
