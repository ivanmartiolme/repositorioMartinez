...
<body>
    <div class="container py-5">
        ...
        <div class="invoice-header">
            ...
            <p><strong>Fecha:</strong> {{ \Carbon\Carbon::now()->setTimeZone('Europe/Madrid')->format('d/m/Y H:i') }}</p>
        ...
        <table class="table table-bordered invoice-table">
            ...
            <tbody>
                @foreach($pagados as $index => $producto)
                    <tr>
                        <td>{{ $index + 1 }}</td>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('ver.pedido') }}" class="btn btn-primary">Continuar pagando</a>
        </div>
    </div>
